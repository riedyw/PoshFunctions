@{
    ...
    'ConvertTo-BinaryIPv4', 'ConvertTo-Bool', 'ConvertTo-DateTime', 'ConvertTo-DecimalIPv4', 
    'ConvertTo-DottedDecimalIPv4', 'ConvertTo-Markdown', 'ConvertTo-OrderedDictionary', 
    'ConvertTo-PlainText', 'ConvertTo-SecureText', 'ConvertTo-UncPath', 
    'ConvertTo-UrlEncode', 'ConvertTo-UTC', 'Copy-Object', 'Eexit', 'Expand-IPv6', 
    'Expand-String', 'Expand-Tab', 'Export-CSVSortedColumn', 'FileSizeAbove', 
    'FileSizeBelow', 'Format-MacAddress', 'Format-RandomCase', 'Format-ReverseString', 
    ...
    'Get-ExecutableForFile', 'Get-FileEncoding', 'Get-FileName', 'Get-FileWithLeadingSpace', 
    'Get-Folder', 'Get-Font', 'Get-Fortune', 'Get-InstalledModuleVersion', 'Get-IpRange', 
    'Get-LastReboot', 'Get-MachineType', 'Get-MacVendor', 'Get-Magic8Ball', 'Get-Md5Sum', 
    ...
    'Get-RegistryValue', 'Get-Round', 'Get-SaveFile', 'Get-Share', 'Get-SharePermission', 
    'Get-ShareStat', 'Get-Shortcut', 'Get-SID', 'Get-StaticProperty', 'Get-SubnetMaskIPv4', 
    'Get-TruncatedDate', 'Get-Type', 'Get-UrlContent', 'Get-WordCount', 'Get-WordList', 
    'grep', 'Help', 'Invoke-Beep', 'Invoke-Speak', 'Join-Object', 'Lock-Workstation', 
    'Measure-Char', 'mklink', 'Move-ToRecycleBin', 'New-InputBox', 'New-Popup', 'New-QR', 
    ...
    'Test-IsValidEmailAddress', 'Test-IsValidIPv4', 'Test-IsValidIPv6', 'Test-NtpDateVsNow', 
