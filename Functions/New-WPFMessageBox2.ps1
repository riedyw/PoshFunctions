...
#>
    ...
    DynamicParam {
        ...
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($ContentBackground, [string], $AttributeCollection)
        ...
        $ValidateSetAttribute = New-Object -TypeName System.Management.Automation.ValidateSetAttribute -ArgumentList ($arrSet)
        $AttributeCollection.Add($ValidateSetAttribute)
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($FontFamily, [string], $AttributeCollection)
        ...
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($TitleFontWeight, [string], $AttributeCollection)
        ...
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($ContentFontWeight, [string], $AttributeCollection)
        ...
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($ContentTextForeground, [string], $AttributeCollection)
        ...
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($TitleTextForeground, [string], $AttributeCollection)
        ...
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($BorderBrush, [string], $AttributeCollection)
        ...
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($TitleBackground, [string], $AttributeCollection)
        ...
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($ButtonTextForeground, [string], $AttributeCollection)
        ...
        $AttributeCollection.Add($ParameterAttribute)
        $arrSet = (Get-ChildItem -Path "$env:SystemDrive\Windows\Media" -Filter Windows* | Select -ExpandProperty Name).Replace('.wav','')
        $ValidateSetAttribute = New-Object -TypeName System.Management.Automation.ValidateSetAttribute -ArgumentList ($arrSet)
        $AttributeCollection.Add($ValidateSetAttribute)
        $RuntimeParameter = New-Object -TypeName System.Management.Automation.RuntimeDefinedParameter -ArgumentList ($Sound, [string], $AttributeCollection)
...
"@
        ...
        Function Add-Button {
            <#
                    .SYNOPSIS
                    Describe purpose of "Add-Button" in 1-2 sentences.
                    ...
                    .LINK
                    URLs to related sites
                    The first link is opened by Get-Help -Online Add-Button
            ...
            $Button.Add_Click({
                    ...
                    write-output -InputObject "$($This.Content.Text)"
                    $Window.Close()
            })
        ...
        If ($OnLoaded)
        {
            $Window.Add_Loaded({
                    $This.Activate()
                    Invoke-Command -ScriptBlock $OnLoaded
            })
        }
        Else
        {
        ...
        If ($OnClosed)
        {
            $Window.Add_Closed({
                    ...
                    Invoke-Command -ScriptBlock $OnClosed
            })
        }
        Else
        {
    ...
    If ($($PSBoundParameters.Sound))
    {
        ...
        $SoundPlayer = New-Object -TypeName System.Media.SoundPlayer -ArgumentList $SoundFile
